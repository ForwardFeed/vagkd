...
use ron::from_str;
use ron::ser::{PrettyConfig, to_string_pretty, Serializer};
use serde::Serialize;
...
pub fn new() -> Generate {
    ...
    stdin().read_line(&mut event_file_input);
    ...
    match event_file {
        Ok(event_file) => return Generate{id : 1,event_file_path: event_file_input},
...
impl Generate {
    ...
    pub fn start(&mut self){
        ...
        let S = to_string_pretty(&config_generated, pretty).expect("Serialization failed");
        self.write_into_file(S);
        exit(0);
    }
    ...
    fn create_keystates(&self) -> config_loader::KeyStates {
        loop {
            ...
            stdin().read_line(&mut key_states);
            key_states.pop();
            match &key_states as &str {
                ...
                "longpress"=>{
                 ...
                 loop {
                     ...
                     stdin().read_line((&mut press_duration_input));
                ...
                "spampress"=>{
                let mut spam_press_time_span  :u64;
                let mut repetition :u16;
                loop {
                    ...
                    stdin().read_line((&mut spam_press_time_span_input));
